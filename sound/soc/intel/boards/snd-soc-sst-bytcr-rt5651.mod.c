...
__used __section(__versions) = {
	...
	{ 0xea1950ef, "devm_fwnode_get_index_gpiod_from_child" },
...
MODULE_INFO(depends, "snd-soc-core,snd,snd-pcm,i2c-core,snd-soc-acpi");


MODULE_INFO(srcversion, "FFAB2800989459F5C0F6AE4");
