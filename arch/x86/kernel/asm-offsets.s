	.file	"asm-offsets.c"
# GNU C89 (Gentoo 9.3.0 p2) version 9.3.0 (x86_64-pc-linux-gnu)
...
# -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/9.3.0/include
...
# -march=k8 -mno-red-zone -mcmodel=kernel -mindirect-branch=thunk-extern
# -mindirect-branch-register -auxbase-strip arch/x86/kernel/asm-offsets.s
