...
deps_fs/btrfs/tests/extent-map-tests.o := \
  ...
  fs/btrfs/tests/../block-rsv.h \

fs/btrfs/tests/extent-map-tests.o: $(deps_fs/btrfs/tests/extent-map-tests.o)
