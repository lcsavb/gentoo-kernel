...
__used __section(__versions) = {
	...
	{ 0x7c1c37e6, "roccat_common2_sysfs_read" },
	{ 0xc96fc3c, "roccat_common2_sysfs_write" },
	{ 0xab06bf8b, "_dev_err" },
	{ 0x48361f, "roccat_connect" },
	{ 0xe6340198, "roccat_common2_device_init_struct" },
...
MODULE_INFO(srcversion, "6152C4EBA83A6A348CF6951");
